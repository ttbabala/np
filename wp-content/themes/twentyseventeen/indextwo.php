...
get_header(); ?>
<body> 
         <div id="logo"><img alt="" src="<?php echo get_stylesheet_directory_uri() ?>/img/balloon_fdb9722.png" /></div>
         <div id="logo-text"><img alt="website-title" src="<?php echo get_stylesheet_directory_uri() ?>/img/logo-text_0f1b4c4.png" /></div>
         <div id="callboard"> 
               <ul>                     
                    <?php 
                                $args = array(
                            ...
                            ?>                       
                            <li> 
                                <span style="color: moccasin"><img alt="" src="<?php echo get_stylesheet_directory_uri() ?>/img/notice-icon.png" /><a href="javascript:;" class="pop-notice" value="<?php the_ID();?>" title="<?php the_title(); ?>" content="<?php the_content()?>"><?php the_title(); ?></a></span> 
                            </li> 
         ...
         <div id="button-download">
                <a href="javascript:;" target="_blank" class="i-bbt-left" id="pop-layer">关于我们</a> 
                <a href="javascript:;" target="_blank" class="i-bbt-right" id="pop-contact">联系我们</a> 
         </div>
         <div id="nav"> 
                <ul> 
        ...
        <div class="side-bar"> 
            <a href="#" class="icon-chat">学院公众�?<div class="chat-tips"><i></i><img style="width:138px;height:138px;" src="<?php echo get_stylesheet_directory_uri() ?>/img/code.jpg" alt="微信订阅�?"></div></a> 
            <a href="http://xwcbxy.nxu.edu.cn/" class="icon-qq">返回学院�?</a>
            <a href="http://www.nxipp.com" class="icon-mail">工作�?</a> 
